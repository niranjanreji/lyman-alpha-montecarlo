...
A lightweight Monte Carlo radiative transfer code for Lyman-alpha photons, designed for standalone use and coupling with the PLUTO hydrodynamics code. Currently, the code is written to work with 1-D spherical hydrodynamics within PLUTO.
