...
CXX      = mpicxx
BASE_CXXFLAGS  = -O3 -std=c++17 -fopenmp
CXXFLAGS_LOCAL = $(BASE_CXXFLAGS) -I. -I$(ROOT) -I$(SRC_DIR)
CXXFLAGS_RT    = $(BASE_CXXFLAGS) -I. -I$(ROOT)
...
ifeq ($(PARALLEL), TRUE)
  CXXFLAGS_LOCAL += -DPARALLEL
  CXXFLAGS_RT    += -DPARALLEL
endif
